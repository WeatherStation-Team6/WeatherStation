<?php
	...
	try{
		...
		foreach($result as $row){
			...
			array_push($temperature, array("x"=> $row->date, "y"=> $row->temp));
...
<body id="body"  class="main">
	...
	<div id="mySidebar" class="sidebar">
		...
		<a href="Hdata.php">10 year data</button></a>
	    ...
	    <div class="Headline"><h1><b>50 years prediction</b></h1></div>
		<div class="text">
		<p>
			Mathematical prediction for the temperature trajectory for the next 50 years.
   		 </p>
		</div>
