...
<head>
   ...
   <script type="text/javascript" src="https://canvasjs.com/assets/script/jquery-1.11.1.min.js"></script>
		...
		$("#airp").click(function ()
	{
		...
		chart.options.data[0].name = "Air pressure";
		chart.options.data[0].type = "column";
...
<body id="body"  class="main">
	...
	<div id="mySidebar" class="sidebar">
	    ...
	    <div class="Headline"><h1><b>7 days prediction</b></h1></div>
		<div class="text">
		<p>
			From this page the prediction for the next 7 days can be viewed. From the dropdown attribute shown in the graph can be changed. Prediction is updated daily.
   		 </p>
		</div>
